...
void gen(Arg* args) {
  ...
  fprintf(s, "#ifndef %s_H", name);
  fprintf(s, "#define %s_H", name);
 
  fprintf(s, "struct %s {", name);
  // TODO: Args
  fprintf(s, "};");
  fprintf(s, "typedef struct %s %s;", name, name);
 
  fprintf(s, "%s* new%s();", name, name);
  fprintf(s, "void free%s(%s* arg);", name, name);
  fprintf(s, "char* cat%s(char* m, %s* arg);", name, name);
